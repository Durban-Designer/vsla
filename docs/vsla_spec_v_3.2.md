...
Padding is logical zero-extension per the equivalence-class model; we only materialize zeros inside the temporary FFT buffers, not in persistent tensors.
