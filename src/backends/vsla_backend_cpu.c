...
#include "cpu/vsla_cpu_helpers.c"              // Core helper functions
#include "cpu/vsla_cpu_memory.c"               // Memory management
#include "cpu/vsla_cpu_arithmetic_unified.c"   // Unified optimized arithmetic operations
#include "cpu/vsla_cpu_fft.c"              // FFT operations
#include "cpu/vsla_cpu_advanced.c"         // Convolution and Kronecker product
#include "cpu/vsla_cpu_reduction.c"        // Reduction operations
#include "cpu/vsla_cpu_shrink.c"           // Shrink operation
#include "cpu/vsla_cpu_stacking.c"         // Stack operation
#include "cpu/vsla_cpu_matmul.c"           // Matrix multiplication
